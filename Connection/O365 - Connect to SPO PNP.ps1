...
#Disconnect-PnPOnline; $Creds = $null;
...
Install-Module SharePointPnPPowerShell2019 -Force -Confirm:$false;
Install-Module SharePointPnPPowerShell2016 -Force -Confirm:$false;
Install-Module SharePointPnPPowerShell2013 -Force -Confirm:$false;
